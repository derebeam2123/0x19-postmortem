Summary
On August, 2023 at midnight the server access went down resulting in some error for anyone trying to access a website. Background on the server being based on a LAMP stack.

Timeline
00:05 PST - Some error for anyone trying to access the website
...
00:12 PST - After quick restart to Apache server returned a status and OK while trying to curl the website.
